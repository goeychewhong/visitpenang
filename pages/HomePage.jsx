        ...
        <div className="min-h-screen flex flex-col items-center justify-center" id="home">
            <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
                    <h1 className="text-4xl mt-32 font-extrabold mb-4 text-center text-gray-900">Welcome to Penang</h1>
                    <p className="text-l mb-12 text-center text-gray-700">Discover the best places to visit, eat, and stay in Penang.</p>
                ...
                <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-FBF4E2 to-transparent"></div>
            </div>
